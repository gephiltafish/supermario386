...
class Brick(Sprite):
    ...
    def __init__(self, screen, settings, block_type):
        ...
        self.brick = "images/redbrick.png"
        self.itembrick = "images/itembrick.png"
        self.floorbrick = "images/floorbrick.png"
        self.stairbrick = "images/stairbrick.png"
        self.emptybrick = "images/emptybrick.png"
        self.invisibrick = "images/invisbrick.png"
